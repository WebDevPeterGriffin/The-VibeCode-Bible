...
export const category: Category = {
    ...
    sections: [
    {
        ...
        "blocks": [
            {
                "type": "p",
                "text": "I'm George. I'm 22, from Armenia, and I run @web.dev.george on Instagram with 27K followers. I build SaaS products, I do client work, and I vibe code basically everything."
            },
            {
                "type": "p",
