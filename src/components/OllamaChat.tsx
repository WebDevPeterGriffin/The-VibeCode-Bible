...
- [Skill Files vs LoRAs](/skill-files-vs-loras) — The dedicated head-to-head for this bible's audience. A skill file is read at runtime (instant, free to change, costs tokens every call, great for facts); a LoRA is baked into the weights (trained once, zero context cost, consistent style, tied to one base model). Best setups use BOTH: LoRA = who the model is, skill files = what it needs to know right now.
