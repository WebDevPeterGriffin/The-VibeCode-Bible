...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body
        className={`${geistSans.variable} ${geistMono.variable} font-sans bg-[var(--color-background)] text-[var(--color-foreground)] min-h-screen flex selection:bg-[var(--color-primary)] selection:text-white flex-col md:flex-row`}
      >
        <Sidebar />
